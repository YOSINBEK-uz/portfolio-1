  ...
  return (
    <div className='w-full h-auto bg-gradient-to-r from-purple-500 to-pink-500 pt-10'>
            <div className="w-full h-[400px] flex items-center justify-center  ">
                <img className='w-[80%] md:w-[65%] h-[300px] md:hover:w-[80%] hover:h-full duration-200 object-cover ' src={loru} alt="" />
            </div>
            <div className="w-full h-[500px] p-10 md:pl-40 md:pr-40 xl:pl-[240px] xl:pr-[240px] ">
                <div className="w-full h-full">
                    ...
                    <h1 className='text-4xl sm:text-5xl font-bold text-white mt-8'>Technologies: <span className='text-cyan-400'>Html, Css</span></h1>
                    <div className="flex items-center justify-between ">
                        <a href="https://yosinbek-uz.github.io/Loru-site/">
